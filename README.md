...
I was also missing checks (CI, automation, builds, etc) which I've come to expect with Github, especially at work.  I wanted to set some up for unit testing some of my tools.  I started a path of discovery using [Foregjo on Codeberg](https://codeberg.org/mrbruno/forgejo-playground) and have learned enough to create a unit test workflow.  I could learn more but I don't have a need right now.
