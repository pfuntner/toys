...
| `markdown`  | ![Not Supported](images/red_x.png)  | ![Supported](images/Green_tick.png) | A format that can only be used for output to produce a table in [Markdown](https://www.wikiwand.com/en/Markdown).  Used extensively in [Slack](https://slack.com/), [Github](https://www.wikiwand.com/en/GitHub), and Jira: Issues (including pull requests), documentation, reviews, etc.  I have often used it to build a table to add to a Jira ticket or Github issue/PR. |
